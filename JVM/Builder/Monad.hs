...
-- | Generator state
data GState = GState {
  generated      :: [Seq.Seq Instruction],      -- ^ Stack of already generated code (head is for current method)
...
putInstruction instr = do
    ...
    case generated st of
        ...
        currentGen:stackedGen -> putGState $ st { generated = (currentGen Seq.|> instr):stackedGen }
...
startMethod flags name sig = do
  ...
  putGState $ st {generated = Seq.empty:generated st,
        ...
        method:stackedMethods -> do
            ...
            modifyGState $ \st ->
                     st {generated = tail $ generated st,
                         ...
                         doneMethods = method':doneMethods st}
...
encodedCodeLength st = fromIntegral . B.length . encodeInstructions . toList $ head $ generated st
...
genCode st = Code {
    ...
    codeInstructions = toList $ head $ generated st,
    codeExceptionsN = 0,
    codeExceptions = [],
    codeAttrsN = 0,
    codeAttributes = AP [] }
